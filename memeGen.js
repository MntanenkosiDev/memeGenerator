function clearAll(){
    const memeCont = document.querySelector('.meme-s');
    const jokesCont = document.querySelector('.joke-s');
    const quotesCont = document.querySelector('.quote-s');
    const riddleCont = document.querySelector('.riddle-s');
...
function showMeme(){
    ...
    newElem.setAttribute('src', randomMeme);

    clearAll();

    document.querySelector('.meme-s').appendChild(newElem)
}
...
function showJokes(){
    ...
    newElem.textContent = randomJoke;

    clearAll();

    document.querySelector('.joke-s').appendChild(newElem);
}
...
function showQuotes(){
    ...
    newElem.textContent = randomQuote.quote;
    newElem2.textContent = "-" + randomQuote.author;

    clearAll();

    document.querySelector('.quote-s').appendChild(newElem)
    document.querySelector('.quote-s').appendChild(newElem2)
}
...
function showRiddles(){
    ...
    elem1.textContent = question;

    const elem2 = document.createElement('p');
    elem2.textContent = "The answer is: " + answer;
    elem2.setAttribute('id', 'riddle-answer');
    elem2.hidden = true;

    clearAll();

    const container = document.querySelector('.riddle-s');
    container.appendChild(elem1)
    container.appendChild(elem2)
    
}

function showRiddleAns(){
    const riddleCont = document.querySelector('.riddle-s');
    const riddle = riddleCont.querySelector('p');
